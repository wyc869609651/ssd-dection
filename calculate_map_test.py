...
annopath = os.path.join('G:\\MachineLearning\\unbalance\\test_data1\\Anno_test', '%s.xml')#测试集标注文件路径
test_imagesetfile = 'G:\\MachineLearning\\unbalance\\test_data1\\core_coreless_test.txt'#测试集里面的图片名
'''
